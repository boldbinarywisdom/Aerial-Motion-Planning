...
def a_star(grid, heuristic_sqrt, start, goal):
    """
    ...
    while not queue.empty():
        ...
        if current_node == goal:
            ...
            for a in valid_actions(grid, current_node):
                ...
                new_cost = current_cost + a.cost + heuristic_sqrt(next_node, goal)
...
# path pruning using collinearity check
def prune_path(path):
